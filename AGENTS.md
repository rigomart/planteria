...
- Audience: an developer arriving with a concrete product idea to ship.
...
- The primary entry point is a workspace hero where a developer types a concrete product idea (e.g. "Auto-expire feature flags..."); everything downstream assumes the prompt already describes a specific build target.
